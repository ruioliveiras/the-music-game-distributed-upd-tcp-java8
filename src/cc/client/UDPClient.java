...
//        }   
    ...
    public void doChallenge(String desafio){
        ...
        Question q3 = new Question("Pergunta 3", s1, 1, "", "");
        Question q4 = new Question("Pergunta 4", s1, 1, "", "");
        Question q5 = new Question("Pergunta 5", s1, 1, "", "");
        Question q6 = new Question("Pergunta 6", s1, 1, "", "");
        Question q7 = new Question("Pergunta 7", s1, 1, "", "");
        Question q8 = new Question("Pergunta 8", s1, 1, "", "");
        Question q9 = new Question("Pergunta 9", s1, 1, "", "");
        Question q10 = new Question("Pergunta 10", s1, 1, "", "");
        ...
        */
        ...
        for(pergunta=0; pergunta<10; pergunta++){
            ...
            //mInt.updateScore(currentPoints); falta meter a mostrar o resultado na interface
